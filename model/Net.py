...
class BiLstmCRF(nn.Module):
    ...
    def __init__(self,
        ...
        # CRF implemented with Transition Matrix.
        self.transition = nn.Parameter(
            torch.ones(self.num_class, self.num_class) * 1/self.num_class)
...
#         # print(hidden_size)
#         # print(embedding_size)
#         self.lstm = nn.LSTM(embedding_size, hidden_size, num_layers, bidirectional=False, batch_first=True)
#         # Here is a one direction LSTM. If bidirection LSTM, (hidden_size*2(,))
#         # self.fc = nn.Linear(hidden_size*2, num_class)
#         self.fc = nn.Linear(hidden_size, num_class)
#         self.init_weights()
